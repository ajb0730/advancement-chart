...
namespace advancementchart.Model.Ranks
{
    public class Tenderfoot : Rank
    {
        ...
        {
            Requirements.Add(new RankRequirement(name: "1a", description: "Prepare for campout", rank: this, handbookPages: "267-273", curriculumGroup: CurriculumGroup.Camping1));
            Requirements.Add(new RankRequirement(name: "1b", description: "Spend one night on campout in tent", rank: this, handbookPages: "", curriculumGroup: CurriculumGroup.Camping2));
            Requirements.Add(new RankRequirement(name: "1c", description: "Tell how you practiced Outdoor Code on outing", rank: this, handbookPages: "223-224", curriculumGroup: CurriculumGroup.OutdoorEthics));
            Requirements.Add(new RankRequirement(name: "2a", description: "Assist with cooking", rank: this, handbookPages: "301,304-305,307-309", curriculumGroup: CurriculumGroup.Cooking));
            Requirements.Add(new RankRequirement(name: "2b", description: "Demonstrate safe meal utensil cleaning", rank: this, handbookPages: "307-309", curriculumGroup: CurriculumGroup.Cooking));
            Requirements.Add(new RankRequirement(name: "2c", description: "Explain importance of eating as patrol", rank: this, handbookPages: "304-305", curriculumGroup: CurriculumGroup.Cooking));
            ...
            Requirements.Add(new RankRequirement(name: "5c", description: "Explain rules of safe hiking", rank: this, handbookPages: "253-255", curriculumGroup: CurriculumGroup.Camping1));
            Requirements.Add(new RankRequirement(name: "6a", description: "Record your best at fitness test", rank: this, handbookPages: "77-81", curriculumGroup: CurriculumGroup.Fitness1));
            Requirements.Add(new RankRequirement(name: "6b", description: "Describe your plan to improve after 30 days", rank: this, handbookPages: "77-81", curriculumGroup: CurriculumGroup.Fitness2));
            Requirements.Add(new RankRequirement(name: "6c", description: "Show improvement at fitness test after 30 days", rank: this, handbookPages: "77-81", curriculumGroup: CurriculumGroup.Fitness2));
            Requirements.Add(new RankRequirement(name: "7a", description: "Demonstrate flag skills", rank: this, handbookPages: "56-60", curriculumGroup: CurriculumGroup.Citizenship));
            ...
            Requirements.Add(new RankRequirement(name: "8", description: "Describe and use EDGE training method", rank: this, handbookPages: "38,365", curriculumGroup: CurriculumGroup.KnotsAndLashings1));
