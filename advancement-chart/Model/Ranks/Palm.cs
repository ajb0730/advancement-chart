...
namespace advancementchart.Model.Ranks
{
    public class Palm : Rank
    {
            ...
            : base(name: $"{Enum.GetName(typeof(PalmType), type)} Palm", description: "", earned: earned, version: "2016")
        {
            ...
            Requirements.Add(new RankRequirement(name: "1", description: "Be active 3 months since earning Eagle Scout or previous Eagle Palm", rank: this, handbookPages: "", timeRequirementMonths: 3));
