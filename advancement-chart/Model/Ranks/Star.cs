...
namespace advancementchart.Model.Ranks
{
    public class Star : Rank
    {
        ...
        {
            Requirements.Add(new RankRequirement(name: "1", description: "Be active 4 months since earning First Class", rank: this, handbookPages: "", timeRequirementMonths: 4));
            ...
            Requirements.Add(new MeritBadgeRequirement(name: "3", description: "Earn 6 merit badges, including any 4 Eagle-required", total: 6, required: 4, rank: this, handbookPages: ""));
